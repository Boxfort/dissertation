...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.11\textwidth,angle=90]{Ganttchart}
...
\includepdf[pages=-]{interim}

\section{Diary Sheets (or other project management evidence)}
\includepdf[page=-]{diaries}
...
\begin{figure}[H]
	\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth, center]{classuml.pdf}}
