\begin{figure}[H]
\begin{adjustbox}{width=0.90\textwidth, center=\textwidth}
\begin{tikzpicture}
\begin{axis}[
    xbar stacked,
    enlargelimits=0.05,
    ...
    \addplot [point meta = x, nodes near coords, nodes near coords align={anchor=west}] coordinates {(0.90,k-NN) (0.98,MLP) (0.99,SVM) 
...
\end{tikzpicture}
\end{adjustbox}
\caption{NSL-KDD Classifiers Precision Graph}
\label{nslprecision}
\end{figure}
