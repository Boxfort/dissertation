...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tab_classifiers.sizePolicy().hasHeightForWidth())
        self.tab_classifiers.setSizePolicy(sizePolicy)
        ...
        self.cmb_graph_class = QtWidgets.QComboBox(self.widget_5)
        self.cmb_graph_class.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cmb_graph_class.sizePolicy().hasHeightForWidth())
        self.cmb_graph_class.setSizePolicy(sizePolicy)
        self.cmb_graph_class.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContentsOnFirstShow)
        self.cmb_graph_class.setObjectName("cmb_graph_class")
        self.horizontalLayout_3.addWidget(self.cmb_graph_class)
        self.btn_show_graph = QtWidgets.QPushButton(self.widget_5)
        self.btn_show_graph.setEnabled(False)
        self.btn_show_graph.setObjectName("btn_show_graph")
        self.horizontalLayout_3.addWidget(self.btn_show_graph)
        self.verticalLayout_6.addWidget(self.widget_5)
        self.graph_container = QtWidgets.QWidget(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.graph_container)
        ...
        self.btn_show_graph.clicked.connect(MainWindow.btn_show_graph_clicked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_show_graph.setText(_translate("MainWindow", "Show"))
