...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_alg1 = QtWidgets.QLineEdit(self.tab_3)
        ...
        self.verticalLayout_4.addWidget(self.txt_alg1)
        self.btn_alg1 = QtWidgets.QPushButton(self.tab_3)
        self.btn_alg1.setObjectName("btn_alg1")
        self.verticalLayout_4.addWidget(self.btn_alg1)
        self.line = QtWidgets.QFrame(self.tab_3)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.verticalLayout_4.addWidget(self.line)
        self.chk_two_stage = QtWidgets.QCheckBox(self.tab_3)
        self.chk_two_stage.setObjectName("chk_two_stage")
        self.verticalLayout_4.addWidget(self.chk_two_stage)
        ...
        self.txt_alg2 = QtWidgets.QLineEdit(self.tab_3)
        ...
        self.verticalLayout_4.addWidget(self.txt_alg2)
        self.btn_alg2 = QtWidgets.QPushButton(self.tab_3)
        self.btn_alg2.setEnabled(False)
        self.btn_alg2.setObjectName("btn_alg2")
        self.verticalLayout_4.addWidget(self.btn_alg2)
        ...
        self.txt_alg1_2 = QtWidgets.QLineEdit(self.tab_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txt_alg1_2.sizePolicy().hasHeightForWidth())
        self.txt_alg1_2.setSizePolicy(sizePolicy)
        self.txt_alg1_2.setObjectName("txt_alg1_2")
        self.verticalLayout_5.addWidget(self.txt_alg1_2)
        self.btn_alg1_2 = QtWidgets.QPushButton(self.tab_4)
        self.btn_alg1_2.setObjectName("btn_alg1_2")
        self.verticalLayout_5.addWidget(self.btn_alg1_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_alg1_2.setText(_translate("MainWindow", "Select Classifier...."))
